...
Tests for user authentication, registration, and login workflows.
Uses clean architecture service layer for mocking API calls.
"""
...
_HOME_MOVIES = "apps.contents.services.get_all_movies"
_HOME_SERIES = "apps.contents.services.get_all_series"
_HOME_GENRES = "apps.contents.services.get_genres_from_api"
_HOME_RATINGS = "apps.contents.services.get_age_ratings_from_api"
_HOME_ENRICH = "apps.contents.services.enrich_tmdb_images"
_REG_GENRES = "apps.contents.services.get_genres_from_api"
_REG_RATINGS = "apps.contents.services.get_age_ratings_from_api"
