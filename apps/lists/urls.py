...
urlpatterns = [
    ...
    path('llistes/afegir/<str:tipus>/<path:content_id>/', add_to_list, name='afegir_a_llista'),
    path('llistes/treure/<str:tipus>/<path:content_id>/', remove_from_list, name='treure_de_llista'),
