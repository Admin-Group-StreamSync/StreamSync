...
Tests for catalog, search, and content detail pages.
Mocks API service calls using clean architecture pattern.
"""
...
_TMDB = "apps.contents.services.get_tmdb_image"
_ENRICH = "apps.contents.services.enrich_tmdb_images"
_SEARCH_GENRES = "apps.contents.services.get_genres_from_api"
_SEARCH_RATINGS = "apps.contents.services.get_age_ratings_from_api"
