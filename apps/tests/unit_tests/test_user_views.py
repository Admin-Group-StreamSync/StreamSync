"""
Unit tests for user views and content management.

Tests for authentication, catalog, content details, lists, and reviews.
Uses clean architecture service layer for mocking.
"""
from django.test import TestCase, Client
from django.urls import reverse
from django.contrib.auth.models import User
from django.contrib.auth import update_session_auth_hash as get_session_auth_hash
